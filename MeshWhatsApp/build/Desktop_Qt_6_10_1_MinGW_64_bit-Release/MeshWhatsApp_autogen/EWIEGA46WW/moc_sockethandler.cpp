...
void SocketHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->newMessageReceived((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (SocketHandler::*)()>(_a, &SocketHandler::disconnected, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketHandler::*)(const QString & )>(_a, &SocketHandler::newMessageReceived, 2))
            return;
    }
}
...
// SIGNAL 2
void SocketHandler::newMessageReceived(const QString & _t1)
{
